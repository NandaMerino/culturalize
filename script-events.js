let EVENTOS = [
    {
        id:1,
        url_img:"./content/img/02-Eventos/01-Eventos-Exposicoes/ExposicaoFotografia.jpg",
    ...
    {
        id:2,
        url_img:"./content/img/02-Eventos/01-Eventos-Exposicoes/ExposicaoPinturas.jpg",
    ...
    {
        id:3,
        url_img:"./content/img/02-Eventos/01-Eventos-Exposicoes/ExposicaoQuadros.jpg",
    ...
    {
        id:4,
        url_img:"./content/img/02-Eventos/02-Eventos-Musicas/musica.jpg",
    ...
    {
        id:5,
        url_img:"./content/img/02-Eventos/03-Eventos-Apresentacoes/cinema.jpg",
    ...
    {
        id:6,
        url_img:"./content/img/02-Eventos/03-Eventos-Apresentacoes/concert.jpg",
    ...
    {
        id:7,
        url_img:"./content/img/02-Eventos/03-Eventos-Apresentacoes/danca.jpg",
        nome:"#Festival de Música Guarani",
        data:"22-04-2023 14:30",
        local: "Avenida 1,  7, Foz do Iguaçu-PR",
        modalidade: "apresentacoes"
    ...
    {
        id:8,
        url_img:"./content/img/02-Eventos/04-Eventos-Literatura/literatura1.jpg",
    ...
    {
        id:9,
        url_img:"./content/img/02-Eventos/04-Eventos-Literatura/literatura2.jpg",
...
function abrirDetalhesEventos(event_id) {
    ...
    if (eventoDetalhes) {
        ...
        <link rel="stylesheet" href="./content/style/events.css">
        </head>
